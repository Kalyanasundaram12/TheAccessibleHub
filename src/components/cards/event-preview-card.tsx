...
export function EventPreviewCard({ event }: EventPreviewCardProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent 
        className="max-w-4xl p-0 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95" 
        onMouseEnter={handleMouseEnter} 
        onMouseLeave={handleMouseLeave}
      >
        <div className="grid md:grid-cols-2">
            ...
            <div className="p-6 flex flex-col">
                 <div className="mb-4 text-left">
                    <DialogTitle asChild>
                      <h2 className="text-2xl text-primary font-bold">{event.name}</h2>
                    </DialogTitle>
                </div>
